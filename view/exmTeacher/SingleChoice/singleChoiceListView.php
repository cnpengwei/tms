...
<?php
	...
	$sql.=" ORDER BY create_time ASC limit ".($pageNow-1)*$pageSize.", $pageSize " ;

	$res=mysql_query($sql, $con);

$tb_head="";
$tb_head.="<table border=1 bordercolor='green' cellspacing='0'>";
$tb_head.="<tr><td>id</td><td>课程编号</td><td>题目描述</td><td>查看详情</td><td>修改题目</td><td>修改题目</td><td>删除题目</td></tr>";
echo $tb_head;
